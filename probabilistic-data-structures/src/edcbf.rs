// Exponentally Decaying Counting Bloom Filter Implementation
...
pub struct ExponentallyDecayingCountingBloomFilter {
    n: i32,
    m: i32,
    k: i32,
    d: u8,
...
impl ExponentallyDecayingCountingBloomFilter {
    pub fn new(m: i32, k: i32) -> ExponentallyDecayingCountingBloomFilter {
        let init_vec = vec![0; m as usize];        

        ExponentallyDecayingCountingBloomFilter {
            n: 0,
            m: m,
            k: k,
            d: 2,
    ...
    pub fn false_positives_rate(self) -> f64 {
        // TODO change probability from BF to EDCBF
